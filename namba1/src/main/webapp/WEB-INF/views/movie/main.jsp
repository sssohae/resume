...
<body>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="trending__product">
						<div class="row">
							<div class="col-lg-8col-md-8col-sm-8">
								<div class="section-title">
									<h4>Trending Now</h4>
								</div>
							</div>
							<div class="col-lg-4col-md-4col-sm-4">
								<div class="btn__all">
					...
					<div class="product__sidebar">
						<div class="product__sidebar__view">
							...
							<div class="filter__gallery">
								<div class="product__sidebar__view__itemset-bgmixdayyears"
								...
								<div class="product__sidebar__view__itemset-bgmixmonthweek"
								...
								<div class="product__sidebar__view__itemset-bgmixweekyears"
								...
								<div class="product__sidebar__view__itemset-bg mixyearsmonth"
								...
								<div class="product__sidebar__view__itemset-bgmixday"
						...
						<div class="product__sidebar__comment">
							...
							<div class="product__sidebar__comment__item">
								...
								<div class="product__sidebar__comment__item__text">
									...
									<span><i class="fafa-eye"></i> 19.141 Viewes</span>
								</div>
							</div>
							<div class="product__sidebar__comment__item">
								<div class="product__sidebar__comment__item__pic">
	...
	<div class="search-model">
		<div class="h-100d-flexalign-items-centerjustify-content-center">
